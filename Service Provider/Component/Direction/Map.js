...
class MapViews extends React.Component {
    ...
    render() {
        ...
        const GOOGLE_MAPS_APIKEY = 'AIzaSyBtLg0L7O-xuyru8HrYdtR1yxIIfxfeqoY'
        return (
            <AppContainer back={true} goBack={() => this.goback()} routeName={'Direction'}>
                <View style={{ flex: 1 }}>
                    {get && sellerLocation ?
                        // <View>
                        < MapView
...
function mapStateToProps(states) {
    return ({
        // UID: state.authReducer.CURRENTUSERUID,
